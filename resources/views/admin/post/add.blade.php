            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <strong>Post</strong> Add Here
                    </div>
                    <div class="card-body card-block">

                        {{-- FORM START HERE --}}
                        <form action="{{url('/admin/post-Submit')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <textarea name="short_description" id="short_description" rows="3" placeholder="Content..." class="form-control"></textarea>
                                </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <textarea name="long_description" id="long_description" rows="5" placeholder="Content..." class="form-control"></textarea>
                                </div>
