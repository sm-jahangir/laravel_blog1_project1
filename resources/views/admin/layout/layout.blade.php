                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="{{url('../admin/post-list')}}">
                                <i class="far fa-check-square"></i>Post</a>
                        </li>
                        <li>
                            <a href="{{url('../admin/page/list')}}">
                                <i class="far fa-check-square"></i>Page</a>
                        </li>
                        <li>
                        ...
                        <li class="has-sub">
                            <a class="js-arrow" href="#">
                                <i class="fas fa-copy"></i>Extra Pages</a>
                            ...
                            <div class="header-button">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="content">
                                            <a class="js-acc-btn" href="#">{{session('BLOG_USER_NAME')}}</a>
                                        </div>
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix">
                                                ...
                                                <div class="content">
                                                    <h5 class="name">
                                                        <a href="#">{{session('BLOG_USER_NAME')}}</a>
                                                    </h5>
                                                    <span class="email">{{session('BLOG_USER_EMAIL')}}</span>
                                                </div>
                                            </div>
