...
<head>
    ...
    <link href="{{ asset('admin_assets') }}/vendor/font-awesome-4.7/css/font-awesome.min.css"
        rel="stylesheet" media="all">
    <link href="{{ asset('admin_assets') }}/vendor/font-awesome-5/css/fontawesome-all.min.css"
        rel="stylesheet" media="all">
    ...
    <!-- Vendor CSS-->
    <link href="{{ asset('admin_assets') }}/vendor/animsition/animsition.min.css" rel="stylesheet"
        media="all">
    <link
    ...
    <link href="{{ asset('admin_assets') }}/vendor/select2/select2.min.css" rel="stylesheet"
        media="all">
    <link href="{{ asset('admin_assets') }}/vendor/perfect-scrollbar/perfect-scrollbar.css"
        rel="stylesheet" media="all">
...
<body class="animsition">
    ...
    <script
        src="{{ asset('admin_assets') }}/vendor/bootstrap-progressbar/bootstrap-progressbar.min.js">
    </script>
